...
static void ImGui_ImplWin32_InitPlatformInterface(HICON icon);
...
// Functions
bool    ImGui_ImplWin32_Init(void* hwnd, void* icon)
{
    ...
    if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
        ImGui_ImplWin32_InitPlatformInterface((HICON)icon);
